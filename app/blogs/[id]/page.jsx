...
const page = ({ params }) => {
    ...
    return (data ? <>
        ...
        <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
            ...
            <p className='my-3'>Managing your lifestyle is a journey taht requires commmitment and self-awareness.By following this step-by-step,you can take control of your life.</p>
            <div className='my-24 '>
